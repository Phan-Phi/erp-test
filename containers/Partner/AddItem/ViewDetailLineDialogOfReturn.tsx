...
import ViewReturnOrderLineTable from "./table/ViewReturnOrderLineTable";
...
const ViewDetailLineDialogOfReturn = ({ open, toggle, url }) => {
...
export default ViewDetailLineDialogOfReturn;
