...
import ViewReceiptOrderLineTable from "./table/ViewReceiptOrderLineTable";
...
const ViewDetailLineDialogOfImport = ({ open, toggle, url }) => {
...
export default ViewDetailLineDialogOfImport;
