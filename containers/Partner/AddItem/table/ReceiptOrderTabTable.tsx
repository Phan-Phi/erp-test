...
type ReceiptOrderTabTableProps = CommonTableProps<any> & Record<string, any>;

const ReceiptOrderTabTable = (props: ReceiptOrderTabTableProps) => {
  const {
    data,
    count,
    maxHeight,
...
export default ReceiptOrderTabTable;
