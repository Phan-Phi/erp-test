...
type ViewPurchaseOrderLineTableProps = CommonTableProps<any> & Record<string, any>;

const ViewPurchaseOrderLineTable = (props: ViewPurchaseOrderLineTableProps) => {
  const {
    data,
    count,
    maxHeight,
...
export default ViewPurchaseOrderLineTable;
