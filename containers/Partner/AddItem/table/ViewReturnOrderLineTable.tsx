...
type ViewReturnOrderLineTableProps = CommonTableProps<any> & Record<string, any>;

const ViewReturnOrderLineTable = (props: ViewReturnOrderLineTableProps) => {
  const {
    data,
    count,
    maxHeight,
    ...
    return [
      ...
      },
      {
        ...
        Cell: (props: PropsWithChildren<CellProps<any, any>>) => {
          ...
          const value: string =
            get(row, "original.receipt_order_quantity.line.unit_price.incl_tax") || "0";
...
export default ViewReturnOrderLineTable;
