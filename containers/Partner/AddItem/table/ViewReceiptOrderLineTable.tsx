...
type ViewReceiptOrderLineTableProps = CommonTableProps<any> & Record<string, any>;

const ViewReceiptOrderLineTable = (props: ViewReceiptOrderLineTableProps) => {
  const {
    data,
    count,
    maxHeight,
...
export default ViewReceiptOrderLineTable;
