...
// export const ViewTypeForFinanceClone = (props: ViewTypeProps) => {
//   const { value } = props;
...
import { Radio, RadioItem, DatePicker, DateRangePicker } from "components";
...
export const ViewTypeForFinance = (props: ViewTypeProps) => {
  const { value, onPeriod, onFilterByTime, onDateRangeChange, filter } = props;
